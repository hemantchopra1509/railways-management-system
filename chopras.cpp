...
public:
    ...
    void displayid() //id displayed in user mode
    {
        cout<<"Id:";
        puts(id);
        cout<<"Password:";
...
class detail  //create database, add train details. 
{
public:
    int tno;
    char tname[50];
    ...
    int c2,c2fare;
    int d,m,y;
    void getdetail() // add details of of trains  
    {
    ...
    void displaydetail() // diplay the train details
    {
...
public:
    ...
    float amc;
    void getresdet() // reservation start
    {
        cout<<"Enter the details as follows\n";
        cout<<"Train no:";
        cin>>tno;
    ...
    void displayresdet() //display reservation and passengers details
    {
        cout<<"...............................................\n";
        cout<<"...............................................\n";
        cout<<"Pnr no:"<<pnr;
...
public:
    ...
    int d,m,y;
    float amr;
    void getcancdet() // get details during cancellation
    {
        cout<<"Enter the details as follows\n";
        cout<<"Pnr no:";
        cin>>pnr;
    ...
    void displaycancdet() // display cancellation
    {
        cout<<"...........................................\n";
        cout<<"...........................................\n";
        cout<<"Pnr no:"<<pnr;
...
void displaypassdetail() // display the details of passangers 
{
	fstream f;
    reser b;
